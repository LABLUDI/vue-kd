	...
	<header class="header">
		<div class="container">
			...
			<div class="header-search__box">
				...
				<input class="header-input" type="text" placeholder="Введи имя, тег, почту..." v-model="ipt" />
			</div>
			<ul class="header-list">
				<li class="header-item">Все</li>
				<li class="header-item">Designers</li>
				<li class="header-item">Analysts</li>
				<li class="header-item">Managers</li>
				<li class="header-item">iOS</li>
				<li class="header-item">Android</li>
				<li class="header-item">{{ ipt }}</li>
			</ul>
		</div>
	</header>
</template>
